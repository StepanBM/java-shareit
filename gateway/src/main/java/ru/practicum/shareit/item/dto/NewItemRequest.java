...
public class NewItemRequest {
    ...
    @Length(max = 255, message = "Название предмета не может привышать длину в 255 символа", groups = CreateValidation.class)
    private String name;

    @NotBlank(message = "Описание не может быть пустым", groups = CreateValidation.class)
    @Length(max = 512, message = "Описание предмета не может привышать длину в 512 символов", groups = CreateValidation.class)
