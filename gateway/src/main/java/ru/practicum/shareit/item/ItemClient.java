...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemId(long userId, long itemId) {
    ...
    public ResponseEntity<Object> addComment(long userId, NewCommentRequest request, long itemId) {
